	    ...
	    <div class="col-md-4">
		  <div class="top_1l">
		    <ul class="mb-0 font_14">
			  <li class="d-inline-block"><a class="text-white a_tag" href="#"><i class="fa fa-phone me-1 col_oran"></i> 9319033590</a></li>
			  <li class="d-inline-block ms-3"><a class="text-white a_tag" href="#"><i class="fa fa-envelope me-1 col_oran"></i>Mahalaxmi93190@gmail.com</a></li>
			</ul>
		  </div>
		</div>
		<div class="col-md-4">
...
<nav class="navbar navbar-expand-md navbar-light  p-0 bg-white" id="navbar_sticky">
  <div class="container-xl">
    <a class="p-0 navbar-brand fw-bold me-0  text-black" href="index.php"><i class="fa-solid fa-om me-1 col_oran"></i> Mahalaxmi <br>
<span class="fw-normal font_14 text-muted">Furniture </span>
</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	   <ul class="navbar-nav mb-0 ms-auto">
		...
		<!-- <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu drop_1" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="shop.php"> Corian  </a></li>
            <li><a class="dropdown-item" href="shop.php"> Wall Hanging  </a></li>
            <li><a class="dropdown-item" href="shop.php"> Pooja Accessiories   </a></li>
            <li><a class="dropdown-item" href="shop.php"> Pooja Ghar   </a></li>
            <li><a class="dropdown-item" href="shop.php"> Premium   </a></li>
            <li><a class="dropdown-item" href="shop.php"> HDHMR </a></li>
