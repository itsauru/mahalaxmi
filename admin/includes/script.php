    ...
    $(document).ready(function() {
        $(".toggle-icon").click(function() {
            ...
            if (input.attr("type") === "password") {
                ...
                icon.attr("src", "https://img.icons8.com/ios-glyphs/30/000000/invisible.png"); // Change to 'invisible' icon
            } else {
                input.attr("type", "password");
                icon.attr("src", "https://img.icons8.com/ios-glyphs/30/000000/visible.png"); // Change back to 'visible' icon
            }
        });
    });
</script>
